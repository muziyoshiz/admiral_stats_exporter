...
function putJson2AS ($json_dir, $access_token) {
    ...
    $AS_HTTP_HEADER_UA = 'AdmiralStatsExporter-PS/1.6.3'
...
try {
    $infoarray = @("Personal/basicInfo", 'Area/captureInfo', 'TcBook/info', 'EquipBook/info', 'Campaign/history', 'Campaign/info', 'Campaign/present', 'CharacterList/info', 'EquipList/info', 'Quest/info', 'Event/info', 'RoomItemList/info')
